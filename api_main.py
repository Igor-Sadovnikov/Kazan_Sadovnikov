...
class MyWidget(QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        # self.lightTheme.setColor(self.lightTheme.ColorGroup.All, self.lightTheme.ColorRole.WindowText, QColor("#000000"))
        # self.lightTheme.setColor(self.lightTheme.ColorGroup.All, self.lightTheme.ColorRole.Button, QColor("#ffffff"))
        # self.lightTheme.setColor(self.lightTheme.ColorGroup.All, self.lightTheme.ColorRole.Light, QColor("#ffffff"))
        # self.lightTheme.setColor(self.lightTheme.ColorGroup.All, self.lightTheme.ColorRole.Midlight, QColor("#ffffff"))
        # self.lightTheme.setColor(self.lightTheme.ColorGroup.All, self.lightTheme.ColorRole.Dark, QColor("#7f7f7f"))
        # self.lightTheme.setColor(self.lightTheme.ColorGroup.All, self.lightTheme.ColorRole.Mid, QColor("#aaaaaa"))
        # self.lightTheme.setColor(self.lightTheme.ColorGroup.All, self.lightTheme.ColorRole.Text, QColor("#000000"))
        # self.lightTheme.setColor(self.lightTheme.ColorGroup.All, self.lightTheme.ColorRole.BrightText, QColor("#ffffff"))
        # self.lightTheme.setColor(self.lightTheme.ColorGroup.All, self.lightTheme.ColorRole.ButtonText, QColor("#000000"))
        # self.lightTheme.setColor(self.lightTheme.ColorGroup.All, self.lightTheme.ColorRole.Base, QColor("#ffffff"))
        # self.lightTheme.setColor(self.lightTheme.ColorGroup.All, self.lightTheme.ColorRole.Window, QColor("#ffffff"))
        # self.lightTheme.setColor(self.lightTheme.ColorGroup.All, self.lightTheme.ColorRole.Shadow, QColor("#000000"))
        # self.lightTheme.setColor(self.lightTheme.ColorGroup.All, self.lightTheme.ColorRole.Highlight, QColor("#0078d7"))
        # self.lightTheme.setColor(self.lightTheme.ColorGroup.All, self.lightTheme.ColorRole.HighlightedText, QColor("#ffffff"))
        # self.lightTheme.setColor(self.lightTheme.ColorGroup.All, self.lightTheme.ColorRole.Link, QColor("#0078d7"))
        # self.lightTheme.setColor(self.lightTheme.ColorGroup.All, self.lightTheme.ColorRole.LinkVisited, QColor("#002642"))
        # self.lightTheme.setColor(self.lightTheme.ColorGroup.All, self.lightTheme.ColorRole.AlternateBase, QColor("#ffffff"))
        # self.lightTheme.setColor(self.lightTheme.ColorGroup.All, self.lightTheme.ColorRole.ToolTipBase, QColor("#ffffdc"))
        # self.lightTheme.setColor(self.lightTheme.ColorGroup.All, self.lightTheme.ColorRole.ToolTipText, QColor("#000000"))
        # self.lightTheme.setColor(self.lightTheme.ColorGroup.All, self.lightTheme.ColorRole.PlaceholderText, QColor(0, 0, 0, 127))
        # self.lightTheme.setColor(self.lightTheme.ColorGroup.All, self.lightTheme.ColorRole.Accent, QColor("#ffffff"))
            ...
            if not self.current_coord:
                ...
                if len(sp) == 2:
                    ...
                    if response:
                        ...
                        toponym = json_response["response"]["GeoObjectCollection"]["featureMember"][0]["GeoObject"] # гео.объект
